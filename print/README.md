...
|---|---|---|
| **letterhead/** | पत्र-शीर्ष · Letterhead | क्रीम बॉन्ड 100 gsm — BILT Royal Executive Bond "Corona Cream" · भारत में A4: `letterhead.pdf` (रंगीन) / `letterhead-mono.pdf` (एक-रंग) · **USA: `letterhead-us.pdf` / `letterhead-us-mono.pdf` (US Letter)** · `letterhead.docx` में पत्र टाइप करें · India prints the A4 files; the USA prints the `-us` Letter files; DOCX to type letters (A4 — set Word's paper to Letter in the US) |
